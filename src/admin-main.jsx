...
import AdminRouter from './infra/router/AdminRouter.jsx';

// Admin entry (admin.html) — served on its own domain (e.g. admin.shop.com).
...
configure({
  ...
  // When an impersonation session ends, return to the admin dashboard.
  impersonationExitPath: '/admin/dashboard',
});
